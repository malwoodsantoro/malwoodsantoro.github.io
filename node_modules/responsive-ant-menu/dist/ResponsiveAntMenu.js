...
var ResponsiveAntMenu = function ResponsiveAntMenu(props) {
  ...
  var menuToRender = /*#__PURE__*/_react["default"].cloneElement(MenuMarkup(onLinkClick()), MenuMarkupConfig);

  return isMobile() ? /*#__PURE__*/_react["default"].createElement(_popover["default"], {
...
ResponsiveAntMenu.propTypes = {
  ...
  theme: (0, _propTypes.oneOfType)([_propTypes.func, _propTypes.string]),
